...
const char* todayStr[4] = { "Sunny", "Partly Cloudy", "Partly Sunny", "Cloudy" };
...
void draw() {
  ...
  lcd.drawStr(1, 10, "06");
  lcd.drawStr(26, 10, "09");
  lcd.drawStr(51, 10, "12");
  lcd.drawStr(76, 10, "15");
  lcd.drawStr(101, 10, "18");
}
...
void loop() {
  ...
  if (now.hour() % 3 == 2 && now.minute() == 0 && now.second() == 0) {
